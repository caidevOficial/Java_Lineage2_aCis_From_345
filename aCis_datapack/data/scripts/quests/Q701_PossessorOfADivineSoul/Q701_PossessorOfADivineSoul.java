 ...
 */
package quests.Q701_PossessorOfADivineSoul;
...
public class Q701_PossessorOfADivineSoul extends Quest
{
	...
	public Q701_PossessorOfADivineSoul()
	{
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		switch (st.getState())
		{
			case STATE_CREATED:
				...
				{
					if (!player.isNoble() || player.getLevel() < 78)
	...
	{
		new Q701_PossessorOfADivineSoul();
	}
}