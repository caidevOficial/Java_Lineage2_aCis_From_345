...
public final class Config
{
	...
	public static void load()
	{
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			ALLOW_RANDOM_FIGHT = MODS.getProperty("AllowRandomFight",true);
			EVERY_MINUTES = MODS.getProperty("EveryMinutes",3);
			RANDOM_FIGHT_REWARD_ID = MODS.getProperty("RewardId" , 8762);
			RANDOM_FIGHT_REWARD_COUNT = MODS.getProperty("RewardCount" , 5);
			ALLOW_SOCIAL_ACTIONS = Boolean.parseBoolean(MODS.getProperty("AllowSocialActions", "false"));
